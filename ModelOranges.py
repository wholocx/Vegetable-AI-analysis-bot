...
if __name__ == '__main__':    
    ...
    bs = 30  #batch size: if your GPU is running out of memory, set a smaller batch size, i.e 16
    sz = 224 #image size
    ds_path = 'thesisProj\DataSetOranges'
    ...
    plt.show()
    path_test = "thesisProj\AnalysisPhoto\Oranges" #The path of your test image
    files = get_image_files(path_test)
    # сделать анализ пачки фото
    for image in files:
